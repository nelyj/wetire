...
class QueriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create query" do
    assert_difference('Query.count') do
      post queries_url, params: { query: { account_id: @query.account_id, description: @query.description, sql: @query.sql, title: @query.title } }
    end
  ...
  test "should update query" do
    patch query_url(@query), params: { query: { account_id: @query.account_id, description: @query.description, sql: @query.sql, title: @query.title } }
